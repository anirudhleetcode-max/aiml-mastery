...
export default function LabsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <header>
        <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-primary">Laboratories</p>
      ...
      <section>
        <h2 className="mb-3 flex items-center gap-2 text-[14px] font-semibold text-ink">
          <Sparkles size={15} className="text-primary" /> Start here
        </h2>
...
function LabCard({ lab, large }: { lab: (typeof LABS)[number]; large?: boolean }) {
  return (
    ...
    >
      ...
      <h3 className="mt-3.5 text-[14.5px] font-semibold text-ink group-hover:text-primary">{lab.title}</h3>
