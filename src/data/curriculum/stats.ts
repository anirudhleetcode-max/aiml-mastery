...

  {
    ...
    workedExample: {
      ...
      steps: [
        ...
        { label: 'What it costs to be sure to 0.05 seconds', detail: 'Solve n ≥ (1.96 × 1.50 / 0.05)² = (58.8)² = 3457.4, so 3458 sessions. Getting from ±0.30 to ±0.05 — a factor of six — costs thirty-five times the data.', latex: 'n \\ge \\left(\\frac{1.96 \\times 1.50}{0.05}\\right)^2 \\approx 3458' },
